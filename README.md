...
# iProov Biometrics Android SDK v6.0.0-beta2
...
3. Add the iProov SDK to the dependencies section in your app's build.gradle file:
	...
	```groovy
	dependencies {
	    implementation('com.iproov.sdk:iproov:6.0.0-beta2')
	}
	```
...
```groovy
dependencies {
    implementation('com.iproov.sdk:iproov-blazeface:6.0.0-beta2')
}
```
...
```groovy
dependencies {
	implementation('com.iproov.sdk:iproov-mlkit:6.0.0-beta2')
}
```

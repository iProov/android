...
# iProov Biometrics Android SDK v7.5.2
...
3. Add the iProov SDK to the dependencies section in your app's build.gradle file:
    ...
    ```groovy
    dependencies {
        implementation('com.iproov.sdk:iproov:7.5.2')
    }
    ```
...
```groovy
dependencies {
   implementation('com.iproov.sdk:iproov-blazeface:7.5.2')
}
```
...
```groovy
dependencies {
   implementation('com.iproov.sdk:iproov-mlkit:7.5.2')
}
```
